...
class HomepageNav(SeleniumBase):
    ...
    def __init__(self, driver):
        ...
        self.driver = driver
        self.__nav_links: str = '.subheader-nav>a'
        self.NAV_LINK_TEXT ='Стройматериалы,Инструмент,Электрика,Инженерные системы,Интерьер и отделка,Сантехника,' \
                            'Крепеж,Благоустройство,Новинки'
